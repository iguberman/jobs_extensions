...
%%-------------------------------------------------------------------
%% File    : jobs_queue_mem_friendly.erl
%% @author  : Irina Guberman <irina.guberman@gmail.com>
%% @end
%% Description :
%% jobs_queue behavior implementation that is similar to the the default queue
%% provided by the 'jobs' framework but is memory-aware and its max size is configured
%% in percentage of free memory rather than number of entries.
%% Optionally, any entries that can't make it into the queue when memory limit is reached
%% will be stored on disk rather than dropped.
%%
%% Created : 20. Apr 2015 by Irina Guberman <irina.guberman@gmail.com>
%%-------------------------------------------------------------------
%%
-module(jobs_queue_mem_friendly).
-author('irina.guberman@gmail.com').
-copyright('Irina Guberman').
...
%%
%% Enqueue a job refrence; return the updated queue
%%e
